...
public class PsychometricController {
    ...
    public ResponseEntity<?> submitTest(
            @PathVariable Long attemptId,@PathVariable Long userId,@RequestBody List<AnswerDto> answers) {

        Map<String, Object> stringObjectMap = psychometricService.submitTest(attemptId, userId, answers);
